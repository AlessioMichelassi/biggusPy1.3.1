...
openCvNodeFolderPath: str = r"elements/Nodes/openCvNode"
pythonNodeFolderPath: str = r"elements/Nodes/PythonNodes"
pyQt5NodeFolderPath: str = r"elements/Nodes/pyqt5Node"
        ...
        for _file in os.listdir(itemList):
            if _file.endswith('.py'):
                ...
                if os.path.isfile(file):
                    ...
                    draggableObj.setIcon("elements/imgs/BiggusIcon.ico")
